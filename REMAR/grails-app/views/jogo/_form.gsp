...
<div class="fieldcontain ${hasErrors(bean: jogoInstance, field: 'manifest', 'error')} required">
	<label for="manifest">
		<g:message code="jogo.manifest.label" default="Manifest" />
		<span class="required-indicator">*</span>
	</label>
	<g:textField name="manifest" required="" value="${jogoInstance?.manifest}"/>
